sap.ui.define([
	...
	return sap.ui.controller("OVP.OverViewPage.ext.custom", {
		...
		//	var oValue2 = this.oView.byId("ProductID").getValue() || "Northwoods Cranberry Sauce";
			var oValue2 = "";
			var aFilters = [],
				oFilter2;
		...
		*/
		...
		//	var oCustomField2 = this.oView.byId("ProductID");
			var oCustomField2 = "";
			if (oCustomField2 ) {
				oCustomData.SalesOrderID = oCustomField2.getValue() || "Northwoods Cranberry Sauce";
			}
			return oCustomData;
		},
		...
		//	oCustomField2.setValue();
			...
			if (oCustomData) {
				...
				if (oCustomData.ProductName) {
					oCustomField2.setValue(oCustomData.ProductName);
				}
			}
		},
